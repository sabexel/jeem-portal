    ...
    public function index(Request $request)
    {
        ...
        if($role->hasPermissionTo('sales-index')) {
            ...
            if($request->action == 'export'){
                return Excel::download(new SalesExport($starting_date, $ending_date), 'sales.xlsx');
            }
            if($request->action == 'today_export'){
                return Excel::download(new SalesExport(date('Y-m-d'), date('Y-m-d')), 'today_s_sales.xlsx');
            }
        ...
        try {*/
            ...
            if($data['pos']) {
                ...
                if(!isset($data['reference_no']))
                    ...
                    $data['reference_no'] = date("Ymd") . date("his");
            }
            ...
            $data['shipping_pieces'] = $request->shipping_pieces;
            $data['package_weight'] = $request->package_weight;
