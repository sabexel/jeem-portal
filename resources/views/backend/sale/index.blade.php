            ...
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="form-group">
                            <button class="btn btn-primary" id="filter-btn" type="submit" name="action" value="submit">{{trans('file.submit')}}</button>
                            <button class="btn btn-secondary" id="export-btn" type="submit" name="action" value="export">Export</button>
                            <button class="btn btn-dark" id="export-btn-today" type="submit" name="action" value="today_export">Export Today</button>
                        </div>
                    </div>
                </div>
                {!! Form::close() !!}
