                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Pieces *</label>
                                            <select name="shipping_pieces" class="form-control">
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <div class="form-group">
                    ...
                    <select name="city" class="form-control">
                        ...
                        <option value="AUHFAR">AUHFAR</option>
                        <option value="AJM">AJM</option>
                        <option value="ALN">ALN</option>
                        <option value="ALNFAR">ALNFAR</option>
                        <option value="DXB">DXB</option>
                        <option value="DXBFAR">DXBFAR</option>
                        <option value="FJR">FJR</option>
                        <option value="KHR">KHR</option>
                        <option value="NOREMFAR">NOREMFAR</option>
